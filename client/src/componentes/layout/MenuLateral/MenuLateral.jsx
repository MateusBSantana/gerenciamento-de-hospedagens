      ...
      <div id="sidebar_content" className="flex-grow-1 d-flex flex-column m-0" style={{ backgroundColor: '#006bb4' }}>
        ...
        <ul id="side_items" className="nav flex-column gap-2 flex-grow-1 align-items-start w-100">
          <li className="nav-item side-item w-100">
            <Link to="/home" className="nav-link text-white d-flex align-items-center justify-content-start hover-effect w-100">
          ...
          <li className="nav-item side-item w-100">
            <Link to="/cadastro_reserva" className="nav-link text-white d-flex align-items-center justify-content-start w-100">
          ...
          <li className="nav-item side-item w-100">
            <Link to="/cadastro_hospede" className="nav-link text-white d-flex align-items-center justify-content-start w-100">
          ...
          <li className="nav-item side-item w-100">
            <Link to="/ajustes" className="nav-link text-white d-flex align-items-center justify-content-start w-100">
          ...
          <li className="nav-item side-item mt-auto w-100">
            <Link to="/login" className="nav-link text-white d-flex align-items-center justify-content-start w-100">
